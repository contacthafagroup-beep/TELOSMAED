                  ...
                  {navigation.map((item) => (
                    <div key={item.name}>
                      {item.simple ? (
                        ...
                        <div>
                          <div className="px-4 py-2 text-sm font-semibold text-primary-600 dark:text-dark-primary uppercase tracking-wider">
                            {item.name}
                          </div>
                          {item.dropdownItems?.map((dropdownItem) => (
                            <Link
                              key={dropdownItem.name}
                              href={dropdownItem.href}
                              className={`flex items-center space-x-3 px-6 py-3 text-sm rounded-lg mx-2 transition-all duration-200 ${
                            ...
                            >
                              ...
                              <div>
                                <div className={`font-medium ${dropdownItem.amharic ? 'font-serif' : ''}`}>
                                  {dropdownItem.name}
                                </div>
                                <div className="text-xs text-wisdom dark:text-dark-secondary">
                                  {dropdownItem.description}
                                </div>
                              </div>
                            </Link>
